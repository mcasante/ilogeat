...
const hover = 'hover:bg-lime-300 transition-shadow-0! hover:shadow-[calc(1.2*var(--brutal-shadow-size))_calc(1.2*var(--brutal-shadow-size))_black] hover:translate-[calc(-0.2*var(--brutal-shadow-size))]'
